...
class _SleepWelcomeScreenState extends State<SleepWelcomeScreen>
  ...
  late Animation<double> _fadeSleepTitle;
  ...
  void initState() {
    ...
    _fadeSleepTitle = CurvedAnimation(
      parent: _staggerController,
      ...
      if (status == AnimationStatus.completed && mounted) {
        ...
        Navigator.pushReplacement(
          ...
          PageRouteBuilder(
            ...
            pageBuilder: (_, __, ___) => SleepQuestionnaireScreen(),
    ...
    try {
      ...
      if (user != null) {
        ...
        if (doc.exists && doc.data()!.containsKey('firstName')) {
          setState(() => firstName = doc['firstName']);
        } else {
          setState(() => firstName = user.email?.split('@').first ?? 'there');
        }
      }
    } catch (e) {
      ...
      builder: (context, child) {
        ...
        return Scaffold(
          ...
          body: Stack(
            ...
            children: [
              // Background watermark (grayscale)
              Opacity(
                opacity: 0.07,
                child: Image.asset(
